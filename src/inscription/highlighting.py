    ...
    class InscriptionLexer(RegexLexer):
        ...
        tokens = {
            "root": [
                ...
                (r"\b(if|let|be|from|of|when|while|for|each|index|up|to|otherwise|zero|buffer|array|view|filled|containing|with|at|does|gives|length|record|layout|packed|size|alignment|offset|in|read|write|into|constant|check|require|module|import|extern|export|enum|union|match)\b", Keyword),
