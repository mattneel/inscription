    ...
    class InscriptionLexer(RegexLexer):
        ...
        tokens = {
            "root": [
                ...
                (r"\b(if|let|be|from|of|when|while|for|each|index|up|to|otherwise|zero|buffer|filled|with|at|does|gives|length|record|layout|packed|size|alignment|offset|in|read|write|into|constant|check)\b", Keyword),
