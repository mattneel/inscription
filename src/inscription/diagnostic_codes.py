...
_CODES: tuple[DiagnosticCode, ...] = (
    ...
    _entry(
        ...
        "A build.ins script calls a Build phrase that v0.63 does not define.",
    ...
    _entry(
        ...
        "A build.ins script violates the restricted v0.63 build-script shape.",
    ...
    _entry(
        ...
        "The v0.63 pure interpreter encountered a feature it intentionally does not execute.",
    ...
    _entry(
        ...
        "A type appears in a language position that v0.63 does not support.",
