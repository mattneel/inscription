module {
  func.func @copy(%source: memref<4xi32>, %destination: memref<4xi32>) {
    ...
    ^bb0(%i_body: i32):
      ...
      %5 = memref.load %source[%4] : memref<4xi32>
      %6 = arith.index_cast %i_body : i32 to index
      memref.store %5, %destination[%6] : memref<4xi32>
  ...
  func.func @main() -> i32 {
    ...
    %6 = memref.alloca() : memref<4xi32>
    %7 = arith.constant 0 : i32
    %8 = arith.constant 0 : index
    %9 = arith.constant 4 : index
    %10 = arith.constant 1 : index
    scf.for %11 = %8 to %9 step %10 {
      memref.store %7, %6[%11] : memref<4xi32>
    }
    func.call @copy(%0, %6) : (memref<4xi32>, memref<4xi32>) -> ()
    %12 = func.call @sum_buffer(%6) : (memref<4xi32>) -> i32
    return %12 : i32
  }
}
