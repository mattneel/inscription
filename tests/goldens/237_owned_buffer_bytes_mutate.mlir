module {
  func.func @owned_bytes_mutate() -> i32 {
    ...
    %12 = arith.constant 72 : i8
    %13 = arith.constant 0 : index
    memref.store %12, %2[%13] : memref<?xi8>
    %14 = arith.constant 0 : index
    %15 = memref.load %2[%14] : memref<?xi8>
  ...
  func.func @main() -> i32 {
    %0 = func.call @owned_bytes_mutate() : () -> i32
    return %0 : i32
  }
}
