module {
  ...
  func.func @add_one_to_buffer(%cells: memref<4xi32>) {
    %0 = arith.constant 0 : i32
    %1 = scf.while (%i_before = %0) : (i32) -> i32 {
      %2 = arith.constant 4 : i32
      %3 = arith.cmpi slt, %i_before, %2 : i32
    ...
    ^bb0(%i_body: i32):
      ...
      %8 = arith.index_cast %i_body : i32 to index
      memref.store %7, %cells[%8] : memref<4xi32>
      %9 = arith.addi %i_body, %6 : i32
      scf.yield %9 : i32
    }
    return
  }
  ...
  func.func @main() -> i32 {
    ...
    func.call @add_one_to_buffer(%0) : (memref<4xi32>) -> ()
