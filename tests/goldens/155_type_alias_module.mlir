module {
  func.func @modules__Types__sum_cells(%cells_base: memref<?xi32>, %cells_start: i32, %cells_length: i32) -> i32 {
  ...
  func.func @main() -> i32 {
    ...
    %9 = func.call @modules__Types__sum_cells(%6, %7, %8) : (memref<?xi32>, i32, i32) -> i32
    return %9 : i32
  }
}
