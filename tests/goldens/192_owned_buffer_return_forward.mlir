module {
  ...
  func.func @forward_ones(%count: i32) -> (memref<?xi32>, i32) {
    %0:2 = func.call @make_ones(%count) : (i32) -> (memref<?xi32>, i32)
    return %0#0, %0#1 : memref<?xi32>, i32
  }

  func.func @main() -> i32 {
    %0 = arith.constant 5 : i32
    %1:2 = func.call @forward_ones(%0) : (i32) -> (memref<?xi32>, i32)
