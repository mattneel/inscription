...
- [`docs/inscription-v0.60-spec.md`](docs/inscription-v0.60-spec.md): current language sprint spec
- [`grammar/inscription-v0.60.ebnf`](grammar/inscription-v0.60.ebnf): current grammar mirror
