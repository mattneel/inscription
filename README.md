...
- [`docs/inscription-v0.63-spec.md`](docs/inscription-v0.63-spec.md): current language sprint spec
- [`grammar/inscription-v0.63.ebnf`](grammar/inscription-v0.63.ebnf): current grammar mirror
