...
- modules, imports, package-aware module roots, local path dependencies, package skeleton generation, package-wide formatting, safe package clean, package release bundles and archives/checksums, package health diagnostics, package build artifact routing, and `build.ins` standard workflow shortcuts plus named release/clean/format/artifact/check/test/group/book steps
...
- [`docs/inscription-v0.61-spec.md`](docs/inscription-v0.61-spec.md): current language sprint spec
- [`grammar/inscription-v0.61.ebnf`](grammar/inscription-v0.61.ebnf): current grammar mirror
