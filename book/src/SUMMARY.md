...
[Prose-Punctuation Syntax](prose-punctuation-syntax.md)

# Tutorial

- [Hello, Inscription](tutorial/hello-inscription.md)
- [Scalar Programs](tutorial/scalar-programs.md)
- [Control Flow](tutorial/control-flow.md)
- [Buffers, Arrays, and Views](tutorial/buffers-arrays-views.md)
- [Records, Enums, and Unions](tutorial/records-enums-unions.md)
- [Owned Buffers](tutorial/owned-buffers.md)
...
- [Buffers](language/buffers.md)
- [Arrays](language/arrays.md)
- [Views](language/views.md)
- [Owned Buffers](language/owned-buffers.md)
- [Records](language/records.md)
- [Layout Records](language/layout-records.md)
- [Enums](language/enums.md)
- [Unions](language/unions.md)
- [Type Aliases](language/type-aliases.md)
- [Byte Literals](language/byte-literals.md)
- [Externs and Exports](language/externs-and-exports.md)
...
- [Protocol Parser](examples/protocol-parser.md)
- [Checksum](examples/checksum.md)
- [Owned Buffer Builder](examples/owned-buffer-builder.md)
