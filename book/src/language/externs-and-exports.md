...
Extern/export ABI is intentionally scalar-only. Records, unions, buffers, views, arrays, owned buffers, and enums are not exposed through the C/extern boundary in v0.37.
