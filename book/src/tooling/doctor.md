...
Inscription v0.61 added deterministic version reporting and health checks. v0.62 adds source-span diagnostic excerpts across common compiler/package/build errors, v0.63 adds stable diagnostic codes plus `inscription explain`, v0.64 adds structured JSON diagnostics, and v0.65 adds source symbol indexes.
