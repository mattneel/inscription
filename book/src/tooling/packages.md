...
`build.ins`, remote dependencies, registries, lockfiles, version solving, target triples, build profiles, and arbitrary package scripts remain future work.
